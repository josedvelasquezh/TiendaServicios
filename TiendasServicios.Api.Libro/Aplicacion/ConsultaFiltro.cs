...
namespace TiendasServicios.Api.Libro.Aplicacion
{
    public class ConsultaFiltro
    {
        ...
        {
            private const string Message = "No se encontro el libro";
            ...
            {
                var libro = await _contexto.LibreriaMaterial.Where(k => k.LibreriaMaterialId == request.LibroId).FirstOrDefaultAsync();
